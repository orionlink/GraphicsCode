...
class GraphicsRenderer
{
  public:
    ...
    void DrawLine(const pri::PointPrimitive& start, const pri::PointPrimitive& end);
    ...
    // Wu氏抗锯齿直线绘制
    void DrawAntialiasedLine(int x1, int y1, int x2, int y2, const Color& color);
    void DrawAntialiasedLine(const pri::PointPrimitive& start, const pri::PointPrimitive& end);
